...
- **20 slash skills** for the full mod lifecycle — `/dayz-new-mod`, `/dayz-build-pbo`, `/dayz-launch-test`, `/dayz-pack-texture`, `/dayz-types-edit`, `/dayz-types-split`, plus environment helpers (`/dayz-preflight`, `/dayz-mount-p`).

...
<div class="agent-example__turn">
<div class="agent-example__label">Context</div>
<div class="agent-example__content">User wants vanilla-style DayZ output, not invented XML.</div>
</div>
<div class="agent-example__turn">
<div class="agent-example__label">User</div>
<div class="agent-example__content">"Last converter spat out XML and Workbench rejected it. Use the real format this time."</div>
</div>
<div class="agent-example__turn">
<div class="agent-example__label">Assistant</div>
<div class="agent-example__content">"I'll use the figma-to-dayz-layout agent. It emits DayZ's actual `.layout` property-file format (class names ending in Class, bare key-value properties, brace-nested children) per the canonical rules at .claude/skills/_shared/figma-to-dayz-rules.md."</div>
</div>
</div>

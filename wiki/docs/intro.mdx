...
```cmd
git clone https://github.com/DayZ-n-Chill/Agentic-Z.git my-mod
cd my-mod
...
Then walk through [the DayZ modding guide](./dayz-modding) for prerequisites (DayZ Tools, P:\ drive setup, vanilla data extraction) and the end-to-end workflow.

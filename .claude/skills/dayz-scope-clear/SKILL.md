...
description: Lift the active mod scope set by /dayz-scope-mod. Removes the deny rules added to .claude/settings.local.json and clears the active-scope state file. No-op if no scope is active. Equivalent to running /dayz-scope-mod with --clear.
---
